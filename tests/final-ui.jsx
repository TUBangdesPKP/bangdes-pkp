...
window.fetch = async (url, options) => {
  ...
  const calculation={modul:context.modul,complete:true,warnings:[],jabatan:'Analis Perumahan',sources:{tarif:'Data_Pegawai, baris uji, kolom Besaran Uang Makan'},
    totals:{masuk:1,hariKerja:4,dinas:2,cuti:1,tb:0,libur:1,flexi:0,terlambat:1,psw:1,tidakMasuk:0,menitTelat:15,menitPsw:31,menitTanpaPresensi:0,totalMenit:46,potonganAbsensi:1.25,lupaAbsen:2,adjusted:1,unadjusted:1,adjustmentMonths:{'2026-08':1,'2026-09':0}},
