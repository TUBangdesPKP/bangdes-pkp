...
window.fetch=async (_url,options)=>{
  ...
  return Response.json({status:'success',publicView:true,month:'2026-08',months:['2026-08'],employees:[{nip:'public-0',nama:'Pegawai Simulasi',unit:'SubUnit Simulasi',masuk:5,hariKerja:5,dinas:0,cuti:0,tb:0,terlambat:0,psw:0,lupaAbsen:0,adjusted:0,unadjusted:0,assessed:5,clean:5,onTime:5,avgArrival:445}],daily:[{unit:'SubUnit Simulasi',tanggal:'2026-08-03',status:'WFO',libur:false,hadir:true,arrival:445,count:5}],documents:[]});
};
function Fixture(){
