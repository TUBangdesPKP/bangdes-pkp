...
window.fetch=async (_url,options)=>{
  ...
  return Response.json({status:'success',publicView:true,publicationVersion:1,published:true,savedAt:'2026-09-26T02:00:00Z',publishedAt:'2026-09-26T03:00:00Z',wrapVersion:2,month:'2026-08',months:['2026-08'],coverage:{submitted:1,available:1},updatedAt:new Date().toISOString(),employees:[{nip:'public-0',nama:'Pegawai Simulasi',unit:'SubUnit Simulasi',masuk:5,hariKerja:5,dinas:0,cuti:0,tb:0,terlambat:0,psw:0,lupaAbsen:0,adjusted:0,unadjusted:0,assessed:5,clean:5,onTime:5,avgArrival:445,flexi:0,flexiMinutes:0,completeMonth:true}],daily:[{unit:'SubUnit Simulasi',tanggal:'2026-08-03',status:'WFO',libur:false,hadir:true,arrival:445,count:5}],documents:[]});
};
